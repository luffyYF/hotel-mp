	...
	<view class="roomReservation">
		...
		<view class="room-info">
			...
			<view class="locationMsg">
				...
				<view class="circum">
					<p>酒店位于香洲区凤凰北香埠路116号，坐拥香洲区繁华地带，毗邻尚都百货、香洲百货、扬名广场购中中心，周边美食丰盛。</p>
				</view>
			</view>
			...
			<view class="room-list" v-for="item in count" :key="item" @click="gotoRoomInfo(item)">
				...
				<view class="room-type">
					...
					<view><button @click="gotoPrice">预订房间</button></view>
				</view>
			</view>
		</view>
	</view>
