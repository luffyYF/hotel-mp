	...
	<view class="hotel-query">
		...
		<view class="card-list">
			...
			<view class="search-box">
				...
				<view class="search-item" hover-class="hover-class"><input placeholder="请输入关键字/酒店/地址" class="search-ipt" /></view>
				<view class="search-item" hover-class="hover-class"><input placeholder="价格星级" class="search-ipt" /></view>
				<button class="check-btn searchBtn" @click="filterMore()">查找酒店</button>
			</view>
			<!-- 功能入口 -->
			<view class="tool row">
			...
			<view class="card-list card card-ios hotels">
				<view text-center="" class="card-header card-header-ios">
					<h2 class="header-title"><span>优选酒店</span></h2>
				...
				<view class="card-content card-content-ios hotels-content">
					<image src="http://www.housefeel.cn/file/rentPath/20181214180440638808038.jpg" mode="aspectFill">
						<span class="tag">
							¥198/
							<view class="small">晚</view>
						</span>
					</image>

					<view class="card-title card-title-ios">香泉酒店 - 商务双人房</view>
					<p>
						<span class="grade">5.0</span>
						<score>
							<div class="star-div">
								<!---->
								<div><ion-icon color="chrome3" role="img" class="icon icon-ios icon-ios-chrome3 ion-ios-star" aria-label="star"></ion-icon></div>
								<div><ion-icon color="chrome3" role="img" class="icon icon-ios icon-ios-chrome3 ion-ios-star" aria-label="star"></ion-icon></div>
								<div><ion-icon color="chrome3" role="img" class="icon icon-ios icon-ios-chrome3 ion-ios-star" aria-label="star"></ion-icon></div>
								<div><ion-icon color="chrome3" role="img" class="icon icon-ios icon-ios-chrome3 ion-ios-star" aria-label="star"></ion-icon></div>
								<div><ion-icon color="chrome3" role="img" class="icon icon-ios icon-ios-chrome3 ion-ios-star" aria-label="star"></ion-icon></div>
...
.searchBtn {
	...
	-webkit-box-shadow: 0 2px 10px rgba(136, 102, 39, 0.33);
	box-shadow: 0 2px 10px rgba(136, 102, 39, 0.33);
}
